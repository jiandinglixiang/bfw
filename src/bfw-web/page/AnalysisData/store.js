  ...
  return async function (dispatch) {
    const analysis = await http.getMatchAnalysis(smid).catch((err) => {
      dispatch(setMatchDetails(
        {
          confrontation: [],
          futureSchedule: { team1_future_schedule: [], team2_future_schedule: [] },
          historyCompetition: { team1_history_competition: [], team2_history_competition: [] },
    ...
    const data = {
      ...
      futureSchedule: {
        team1_future_schedule: (analysis.future_schedule && analysis.future_schedule.team1_future_schedule) || [],
        team2_future_schedule: (analysis.future_schedule && analysis.future_schedule.team2_future_schedule) || []
      },
      historyCompetition: {
        team1_history_competition: (analysis.history_competition && analysis.history_competition.team1_history_competition) || [],
        team2_history_competition: (analysis.history_competition && analysis.history_competition.team2_history_competition) || []
      },
